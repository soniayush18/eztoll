...
//                String uore = "ankush";
//                String name_usr = getString(R.string.name_usr, uore);
                ...
                for(i = 0; i < array.length; i++)
                {
                    ...
                    if (usr_given_userName.equals(array[i]) || usr_given_userName.equals(array_email[i]) && user_given_passWord.equals(array_pass[i])){
